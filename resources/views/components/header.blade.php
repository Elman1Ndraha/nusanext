    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-20">
            ...
            <div class="flex items-center space-x-4">
                ...
                {{-- <button class="hidden lg:inline-flex p-2 text-gray-600 hover:text-red-600 hover:bg-gray-100 rounded-lg transition">
                ...
                <!-- CTA Button (Desktop) -->
                <a href="#contact" class="hidden sm:inline-flex px-6 py-2.5 bg-gradient-to-r-red-teal text-white font-semibold rounded-lg hover:shadow-lg hover:shadow-red-500/30 transform hover:scale-105 transition-all duration-300">
                    Get Started
                </a> --}}
